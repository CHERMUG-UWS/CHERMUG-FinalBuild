...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the ESQ_EndSummary scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ESQ_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSflcZoC_di2x2Ud04Q7e410mr7OtTgq74u_eNWNM_PBeMySSw/formResponse";
    ...
    void Start()
    {
        ...
        time = PlayerPrefs.GetString("esq_timer");
        score = PlayerPrefs.GetString("esq_scoreString"); 
        ...
        topicText.text = "Effects of Exercise on Sleep Quality";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateESQ_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("esq_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.2085483414", nameAnswer);
        form.AddField("entry.1475915179", scoreAnswer);
        form.AddField("entry.2023235843", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("esq_scoreString");
        timeAnswer = PlayerPrefs.GetString("esq_timer");
