...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ESQ_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ESQ_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("ESQ_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("ESQ_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
