...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ESQ_QuestionsData scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ESQ_DataQuestions : MonoBehaviour
{
    ...
    {
        //Question 1
        sentences[0] = "Incorrect: This data set doesn’t make sense in this layout.";
        sentences[1] = "Correct: This data set shows you the three categories of exercise, and sleep quality scores.";
        //Question 2
        sentences[2] = "Incorrect: Scatter plots show the relationship between two variables.";
        sentences[3] = "Correct: Box plots will show medians as a measure of central tendency and measures of spread too.";
        //Question 3
        sentences[4] = "Correct: Since there are three different levels of the independent variable (level of exercise), a one-way ANOVA is required.";
