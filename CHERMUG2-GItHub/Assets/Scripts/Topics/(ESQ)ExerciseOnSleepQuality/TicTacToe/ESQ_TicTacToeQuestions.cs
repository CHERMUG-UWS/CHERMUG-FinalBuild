...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ESQ_QuestionsTTT scene.                             ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ESQ_TicTacToeQuestions : MonoBehaviour
{
    ...
    public GameObject boxplotButton;
    ...
    {
        //Question 1
        sentences[0] = "Correct: There is a statistically significant difference in sleep quality between people who engage in low (M=4.38, SD=1.42), medium(M=5.19, SD=1.57) and high (M=5.31, SD=1.38) amounts of exercise, F(2)=7.838, p=0.001.";
        sentences[1] = "Incorrect: There is a statistically significant difference in sleep quality between people who engage in low (M=4.38, SD=1.42), medium(M=5.19, SD=1.57) and high (M=5.31, SD=1.38) amounts of exercise, F(2)=7.838, p=0.001.";
        //Question 2
        ...
        //Question 3
        sentences[4] = "Correct: The results suggest that sleep quality is reduced by doing low amounts of exercise, but that there is not a big difference in sleep quality between medium and high amounts of exercise. People who do low amounts of exercise may improve their sleep quality by increasing exercise to a medium amount.";
        sentences[5] = "Incorrect: Check the box plots to see whether there is a difference between medium and high.";
        sentences[6] = "Incorrect: The median and mean health anxiety scores both decreased over time and the finding is statistically significant.";
    }
    ...
    {
        SceneManager.LoadScene("ESQ_EndSummary");
    }
    ...
    public void Q1()
    {
        ...
        boxplotButton.SetActive(false);

        //Question 1
        q.text = "Which of the following is the correct interpretation of the results?";
        subq.text = "";
        a1q1.text = "There is a statistically significant difference in sleep quality between people who engage in low (M=4.38, SD=1.42), medium(M=5.19, SD=1.57) and high (M=5.31, SD=1.38) amounts of exercise, F(2)=7.838, p=0.001.";
        a2q1.text = "There is not a statistically significant difference in sleep quality between people who engage in low (M=4.38, SD=1.42), medium(M=5.19, SD=1.57) and high (M=5.31, SD=1.38) amounts of exercise, F(2)=7.838, p=0.1.";
    }
    ...
    {   
        ...
        subq.text = "";
        a1q3.text = "The results suggest that sleep quality is reduced by doing low amounts of exercise, but that there is not a big difference in sleep quality between medium and high amounts of exercise. People who do low amounts of exercise may improve their sleep quality by increasing exercise to a medium amount.";
        a2q3.text = "These results show a clear increase in sleep quality for each amount of exercise, suggesting that engaging in more exercise regardless of which group a person already belongs in will increase sleep quality.";
        a3q3.text = "These results suggest that there is no relationship between amount of exercise and sleep quality, as sleep quality does not change between each group.";
    }
    //----------------------------------------------------------------------------------------------------------------------------------------------------------
