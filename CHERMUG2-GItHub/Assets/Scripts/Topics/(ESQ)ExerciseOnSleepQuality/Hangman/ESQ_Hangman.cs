...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the ESQ_Hangman scene.                                         ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ESQ_Hangman : MonoBehaviour
{
    ...
    { 
        SceneManager.LoadScene("ESQ_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct, because there are different categories for amount of exercise.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("ESQ_achievement_01");
                    StartCoroutine(Type());
