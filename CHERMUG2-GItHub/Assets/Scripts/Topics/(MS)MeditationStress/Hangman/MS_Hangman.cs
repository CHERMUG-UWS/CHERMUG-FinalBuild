...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the MS_Hangman scene.                                          ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MS_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("MS_QuestionsHM2");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Ratio: Correct! in this study, participants are assigned a score which may be zero.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("MS_achievement_01");
