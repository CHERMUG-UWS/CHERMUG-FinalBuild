...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the MS_NullHypothesis scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MS_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("MS_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("MS_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
