...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the MS_MultipleChoice scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MS_MultipleChoice : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: \"Before and after meditation\" and \"Stress\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Before and after meditation\" is the independent variable (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("MS_QuestionsHM");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetMSScore();
        }
