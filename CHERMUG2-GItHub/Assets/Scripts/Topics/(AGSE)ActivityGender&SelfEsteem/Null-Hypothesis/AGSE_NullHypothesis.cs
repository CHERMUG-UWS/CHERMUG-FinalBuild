...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("AGSE_NullHypothesis2");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("AGSE_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
