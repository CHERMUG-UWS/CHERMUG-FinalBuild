...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_QuestionsData scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_DataQuestions : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        ...
        sentences[1] = "Incorrect: The dependent variable is missing.";
        //Question 2
        sentences[2] = "Correct: Well done!";
        sentences[3] = "Incorrect: You don’t have a pair of numeric variables for a scatter plot.";
        //Question 3
        sentences[4] = "Correct: You have two independent variables in this study that both have 2 groups.";
