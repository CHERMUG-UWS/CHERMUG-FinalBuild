...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_NullHypothesis3 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_NullHypothesis3 : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("AGSE_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("AGSE_achievement_04");
        }
    }
    //Called from the OnClick function in the Inspector
