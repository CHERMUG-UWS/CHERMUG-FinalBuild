...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_NullHypothesis2 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_NullHypothesis2 : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("AGSE_NullHypothesis3");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("AGSE_achievement_03");
        }
    }
    //Called from the OnClick function in the Inspector
