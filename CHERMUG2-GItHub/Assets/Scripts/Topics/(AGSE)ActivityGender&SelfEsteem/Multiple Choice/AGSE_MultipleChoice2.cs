...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_MultipleChoice2 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"Self esteem\".";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("AGSE_QuestionsHM3");
            }
        }
        ...
        {
            {
                if (toggles[4].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false && toggles[7].isOn == false)
                {
