...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the AGSE_MultipleChoice scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class AGSE_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "Dysmorphia";
        a2.text = "Activity level";
        a3.text = "Intervention type";
        a4.text = "Body image";
        a5.text = "Self esteem";
        a6.text = "Gender";
        a7.text = "Body dissatisfaction";
        a8.text = "Minutes of exercise";
    }
    ...
    {
        sentences[0] = "Correct: \"Activity level\", \"Self esteem\" and \"Gender\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Activity level\" and \"Gender\" are the independent variables (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("AGSE_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetAGSEScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[1].isOn == true && toggles[4].isOn == true && toggles[5].isOn == true && toggles[0].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[6].isOn == false && toggles[7].isOn == false)
            {
        ...
        if (name == "NextButton2")
        {
            if (toggles[1].isOn == true && toggles[5].isOn == true && toggles[0].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[6].isOn == false && toggles[7].isOn == false)
            {
                character.gameObject.GetComponent<CharacterAnims>().states = 2;//Thumbs up anim
                nextButton2.SetActive(false);
                index = 2;
