...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the HADP_MultipleChoice scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class HADP_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "The pandemic";
        a2.text = "Being Spanish";
        a3.text = "Location";
        a4.text = "Health anxiety score";
        a5.text = "Time point during the pandemic";
        a6.text = "Health";
    }
    ...
    {
        sentences[0] = "Correct: \"Health anxiety score\" and \"Time point during the pandemic\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Time point during the pandemic\" is the independent variable (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("HADP_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetHADPScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[3].isOn == true && toggles[4].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[5].isOn == false)
            {
                //positive
