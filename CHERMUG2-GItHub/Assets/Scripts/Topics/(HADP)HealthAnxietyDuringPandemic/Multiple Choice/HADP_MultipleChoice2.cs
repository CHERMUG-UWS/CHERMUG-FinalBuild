...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the HADP_MultipleChoice2 scene.                         ///            
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class HADP_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"Health anxiety score\".";
    ...
    public void ReadyToPlay()
    {
        ...
        a3.text = "Location";
        a4.text = "Health anxiety score"; //correct answer
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("HADP_QuestionsHM2");
            }
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        {
            {
                if (toggles[3].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false)
                {
