...
public class HADP_HangmanQuestions2 : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        ...
        sentences[2] = "Correct: This study is looking at the difference in health anxiety between two different time points.";
        sentences[3] = "Incorrect: This study is looking at the difference in health anxiety between two different time points.";
    }
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b> what level of measurement is appropriate for Health anxiety score?";
        subq.text = "";
        a1.text = "Ratio";
        a2.text = "Nominal";
        a3.text = "Interval";
    ...
    public void Q2()
    {
        ...
        a2.text = "Investigating differences";
