...
public class HADP_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The box plot suggests that health anxiety decreased over time.";
        //q1a1
        sentences[1] = "Incorrect: The box plot suggests that health anxiety decreased over time.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The box plot suggests that the median health anxiety score was higher one week into the pandemic compared to three months later.";
        //q2a2
        sentences[3] = "Incorrect: The box plot suggests that the median health anxiety score was higher one week into the pandemic compared to three months later.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The box plot shows more variability in anxiety at the three month point of the pandemic.";
        //q3a1
        sentences[5] = "Incorrect: The box plot shows more variability in anxiety at the three month point of the pandemic.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The table of results shows that the mean health anxiety at 3 months was 10.29.";
        //q4a1
        sentences[7] = "Incorrect: The table of results shows that the mean health anxiety at 3 months was 10.29.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The table of results shows that the mean health anxiety at the start was 11.66.";
        //q5a2
        sentences[9] = "Incorrect: The table of results shows that the mean health anxiety at the start was 11.66.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The table of results shows that mean health anxiety decreased by 1.37 points.";
        //q6a2
        sentences[11] = "Incorrect: The table of results shows that mean health anxiety decreased by 1.37 points.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The p-value of .000 shows that the result is statistically significant.";
        //q7a2
        sentences[13] = "Incorrect: The p-value of .000 shows that the result is statistically significant.";
        //question 8
        //q8a2
        sentences[14] = "Correct: Overall the table of results show that health anxiety decreased over time.";
        //q8a1
        sentences[15] = "Incorrect: Overall the table of results show that health anxiety decreased over time.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value indicates that we can reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value indicates that we can reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("HADP_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddHADPTicTacToeScore();
            AchievementManager.instance.Unlock("HADP_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot suggests that health anxiety did not change over time.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The box plot suggests that the median health anxiety score was higher one week into the pandemic compared to three months later.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The box plot shows more variability in anxiety in week one of the pandemic.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The table of results shows that the mean health anxiety at 3 months was 1.361.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The table of results shows that the mean health anxiety at the start was 11.66.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The table of results shows that mean health anxiety decreased by 1.37 points.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The p-value of .000 shows that the result is statistically significant.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "Overall the table of results show that health anxiety increased over time.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value indicates that we fail to reject the null hypothesis.";
            question.SetActive(true);
