...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the HADP_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class HADP_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("HADP_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("HADP_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
