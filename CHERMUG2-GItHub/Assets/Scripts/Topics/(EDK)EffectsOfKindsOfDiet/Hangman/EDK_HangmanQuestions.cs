...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EDK_QuestionsHM scene.                              ///
///                                                                                                         ///                    
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_HangmanQuestions : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: Participants only take part in one of the two diets.";
        sentences[1] = "Incorrect: Participants only take part in one of the two diets.";
    }
    ...
    {
        SceneManager.LoadScene("EDK_MultipleChoice2");
    }
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b> is Type of diet a between or within participants study?";
        subq.text = "";
        a1.text = "Within participants";
        a2.text = "Between participants";
