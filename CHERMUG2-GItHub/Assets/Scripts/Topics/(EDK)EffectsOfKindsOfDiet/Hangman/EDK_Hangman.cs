...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the EDK_Hangman scene.                                         ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_Hangman : MonoBehaviour
{
    ...
    {  
        SceneManager.LoadScene("EDK_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct, because there are different categories of Type of diet.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("EDK_achievement_01");
