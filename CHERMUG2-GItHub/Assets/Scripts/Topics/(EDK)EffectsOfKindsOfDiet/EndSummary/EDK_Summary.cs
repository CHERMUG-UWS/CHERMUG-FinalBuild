...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the EDK_EndSummary scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSeH5Kjm3Lu2h6UCQjUMMaovheK7yTrnSW9lSbrdWLOUfPjqTA/formResponse";
    ...
    void Start()
    {
        ...
        time = PlayerPrefs.GetString("edk_timer");
        score = PlayerPrefs.GetString("edk_scoreString"); 
        ...
        topicText.text = "Effects of Different Kinds of Diet on Weight Loss";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateEDK_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("edk_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.752437604", nameAnswer);
        form.AddField("entry.720112346", scoreAnswer);
        form.AddField("entry.24054245", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("edk_scoreString");
        timeAnswer = PlayerPrefs.GetString("edk_timer");
