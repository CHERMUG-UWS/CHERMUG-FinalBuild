...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EDK_NullHypothesis2 scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_NullHypothesis2 : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("EDK_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("EDK_achievement_03");
        }
    }
    //Called from the OnClick function in the Inspector
