...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EDK_MultipleChoice2 scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"Weight loss in kgs\".";
    ...
    public void ReadyToPlay()
    {
        ...
        a5.text = "Weight loss in kgs"; //correct answer
        a6.text = "Health";
    }
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("EDK_QuestionsHM2");
            }
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------
