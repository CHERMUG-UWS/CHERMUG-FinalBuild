...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EDK_MultipleChoice scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "Lo-carb diet";
        a2.text = "Fat-buster diet";
        a3.text = "Type of diet";
        a4.text = "Weight at the beginning";
        a5.text = "Weight loss in kgs";
        a6.text = "Health";
    }
    ...
    {
        sentences[0] = "Correct: \"Type of diet\" and \"Weight loss in kgs\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Type of diet\" is the independent variable (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("EDK_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetEDKScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[2].isOn == true && toggles[4].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[3].isOn == false && toggles[5].isOn == false)
            {
                //positive
        ...
        if (name == "NextButton2")
        {
            if (toggles[2].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false)
            {
                character.gameObject.GetComponent<CharacterAnims>().states = 2;//Thumbs up anim
                nextButton2.SetActive(false);
                index = 2;
