...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the EDK_TicTacToe scene.                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EDK_TicTacToe : MonoBehaviour
{
    ...
    [SerializeField] private GameObject histogram;
    ...
    void Awake()
    {
        ...
        histogram = GameObject.Find("HistogramGraph");
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The histogram shows that the median weight loss was higher for participants on the Fat-buster diet than for those on the Lo-carb diet.";
        //q1a1
        sentences[1] = "Incorrect: The histogram shows that the median weight loss was higher for participants on the Fat-buster diet than for those on the Lo-carb diet.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The histogram shows that there was more variability in weight loss for participants on the Lo-carb diet.";
        //q2a2
        sentences[3] = "Incorrect: The histogram shows that there was more variability in weight loss for participants on the Lo-carb diet.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The table of results shows that the mean weight lost by those on the Fat-buster diet was 4.837 kgs.";
        //q3a1
        sentences[5] = "Incorrect: The table of results shows that the mean weight lost by those on the Fat-buster diet was 4.837 kgs.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The histogram shows that some people on the Lo-carb diet put on weight instead of losing weight.";
        //q4a1
        sentences[7] = "Incorrect: The histogram shows that some people on the Lo-carb diet put on weight instead of losing weight.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The table of results shows that the mean weight lost by those on the Lo-carb diet was 3.217 kgs.";
        //q5a2
        sentences[9] = "Incorrect: The table of results shows that the mean weight lost by those on the Lo-carb diet was 3.217 kgs.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The table of results shows that on average those on the Fat-buster diet lost more weight than those on the Lo-carb diet.";
        //q6a2
        sentences[11] = "Incorrect: The table of results shows that on average those on the Fat-buster diet lost more weight than those on the Lo-carb diet.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The table of results shows that the standard deviation for those on the Lo-carb diet was much larger than those on the Fat-buster diet.";
        //q7a2
        sentences[13] = "Incorrect: The table of results shows that the standard deviation for those on the Lo-carb diet was much larger than those on the Fat-buster diet.";
        //question 8
        //q8a2
        sentences[14] = "Correct: Levene’s test for equality of variances suggests that the two group variances are not equal, as the p-value is significant for this test.";
        //q8a1
        sentences[15] = "Incorrect: Levene’s test for equality of variances suggests that the two group variances are not equal, as the p-value is significant for this test.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value of the t-test shows that we should reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value of the t-test shows that we should reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("EDK_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddEDKTicTacToeScore();
            AchievementManager.instance.Unlock("EDK_achievement_04");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot shows that the median weight loss was higher for participants on the Fat-buster diet than for those on the Lo-carb diet.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The histogram shows that there was more variability in weight loss for participants on the Fat-buster diet than the Lo-carb diet.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The table of results shows that the mean weight lost by those on the Fat-buster diet was .9428 kgs.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The histogram shows that some people on the Lo-carb diet put on weight instead of losing weight.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The table of results shows that the mean weight lost by those on the Lo-carb diet was 4.303 kgs.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The table of results shows that on average those on the Fat-buster diet lost more weight than those on the Lo-carb diet.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The table of results shows that the standard deviation for those on the Lo-carb diet was much larger than those on the Fat-buster diet.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "Levene’s test for equality of variances suggests that the variances of the two groups are equal.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value of the t-test shows that we should reject the null hypothesis";
            question.SetActive(true);
