...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ITBP_MultipleChoice scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        q.text = "In this <b>study</b> what are the three variables?";
        ...
        a1.text = "Dysmorphia";
        a2.text = "Modern intervention";
        a3.text = "Body image";
        a4.text = "Body positivity";
        a5.text = "Intervention type";
        a6.text = "Gender";
        a7.text = "Traditional intervention";
        a8.text = "Intervention time point";
    }
    ...
    public void ResetQ2()
    {
        ...
        //Question 2
        q.text = "In this <b>study</b> what are the two independent variables?";
        subq.text = "Select from the answers below, remember there may be more than one answer." +
            " Click <b>submit answer</b> when you have made your choice.";
        a1.text = "Dysmorphia";
        a2.text = "Modern intervention";
    ...
    {
        sentences[0] = "Correct: \"Body positivity\", \"Intervention type\" and \"Intervention time point\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Intervention type\" and \"Intervention time point\" are the independent variables (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("ITBP_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetITBPScore();
        }
        ...
        if (name == "NextButton")
        {
            ...
            if (toggles[3].isOn == true && toggles[4].isOn == true && toggles[7].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false)
            {
                //positive
        ...
        if (name == "NextButton2")
        {
            if (toggles[4].isOn == true && toggles[7].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false)
            {
                character.gameObject.GetComponent<CharacterAnims>().states = 2;//Thumbs up anim
                nextButton2.SetActive(false);
                index = 2;
