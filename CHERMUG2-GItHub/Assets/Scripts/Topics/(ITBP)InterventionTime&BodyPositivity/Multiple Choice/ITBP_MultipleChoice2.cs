...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ITBP_MultipleChoice2 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"Body positivity\".";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("ITBP_QuestionsHM3");
            }
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        {
            {
                if (toggles[3].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false && toggles[7].isOn == false)
                {
