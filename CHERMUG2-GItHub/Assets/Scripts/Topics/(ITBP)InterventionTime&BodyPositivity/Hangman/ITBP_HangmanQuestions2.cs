...
public class ITBP_HangmanQuestions2 : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        ...
        sentences[4] = "Correct: Intervention time point is a within participants variable.";
        sentences[5] = "Incorrect: All participants take part at both time points.";
    }
    ...
    {
        SceneManager.LoadScene("ITBP_MultipleChoice2");
    }
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b> what is the level of measurement of intervention time point?";
        subq.text = "";
        a1.text = "Interval";
        a2.text = "Ordinal";
        a3.text = "Nominal";
    ...
    public void Q2()
    {
        ...
        //Question 2
        q.text = "In this <b>study</b> what are the levels of the variable intervention time point?";
        subq.text = "";
        a1.text = "3 months and 6 months";
        a2.text = "Day 1 and Day 30";
        a3.text = "Start, middle and end of intervention";
        a4.text = "Start and end of intervention";
    ...
    public void Q3()
    {
        ...
        //Question 3
        q.text = "In this <b>study</b> is intervention time point a between or within participants (<i>repeated measures</i>) variable?";
        subq.text = "";
