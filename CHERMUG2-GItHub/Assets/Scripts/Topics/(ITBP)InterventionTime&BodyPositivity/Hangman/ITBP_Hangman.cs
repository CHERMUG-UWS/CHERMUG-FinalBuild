...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the ITBP_Hangman scene.                                        ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("ITBP_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct, because there are different categories of the variable intervention type.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("ITBP_achievement_01");
                    StartCoroutine(Type());
