...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ITBP_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("ITBP_NullHypothesis2");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("ITBP_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
