...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the ITBP_NullHypothesis3 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_NullHypothesis3 : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("ITBP_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("ITBP_achievement_04");
        }
    }
    //Called from the OnClick function in the Inspector
