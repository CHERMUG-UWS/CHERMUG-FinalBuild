...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the ITBP_EndSummary scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class ITBP_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSd5YjYiQ05hJNlcZRreYqxmoQykxysBPv4JU_iijqUvJ0X4lQ/formResponse";
    ...
    void Start()
    {
        ...
        screenCapName = "CertificateITBP_";
        screenCaps = 1;
        ...
        time = PlayerPrefs.GetString("itbp_timer");
        score = PlayerPrefs.GetString("itbp_scoreString"); 
        ...
        topicText.text = "Intervention, Time and Body Positivity";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateITBP_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("itbp_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.1580353823", nameAnswer);
        form.AddField("entry.1968257752", scoreAnswer);
        form.AddField("entry.795508686", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("itbp_scoreString");
        timeAnswer = PlayerPrefs.GetString("itbp_timer");
