...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NMF_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NMF_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("NMF_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("NMF_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
