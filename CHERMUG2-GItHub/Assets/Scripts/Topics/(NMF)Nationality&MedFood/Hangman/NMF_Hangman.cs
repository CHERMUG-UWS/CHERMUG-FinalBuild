...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the NMF_Hangman scene.                                         ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NMF_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("NMF_QuestionsHM2");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Ratio: Correct! In this study the scores for consumption of Mediterranean foods could vary from 0 to 30.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("NMF_achievement_01");
