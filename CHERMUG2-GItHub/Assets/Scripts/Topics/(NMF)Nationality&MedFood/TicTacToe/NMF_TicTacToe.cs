...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the NMF_TicTacToe scene.                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NMF_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The box plot does not show the mean number of Mediterranean foods consumed, it shows the median number of Mediterranean foods consumed.";
        //q1a1
        sentences[1] = "Incorrect: The box plot does not show the mean number of Mediterranean foods consumed, it shows the median number of Mediterranean foods consumed.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The box plot suggests that the median number of Mediterranean foods consumed by Spanish children is higher than the median number consumed by British children.";
        //q2a2
        sentences[3] = "Incorrect: The box plot suggests that the median number of Mediterranean foods consumed by Spanish children is higher than the median number consumed by British children.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The box plot shows that there is slightly more variability in number of Mediterranean foods consumed by British children than by Spanish children.";
        //q3a1
        sentences[5] = "Incorrect: The box plot shows that there is slightly more variability in number of Mediterranean foods consumed by British children than by Spanish children.";
        //question 4
        //q4a2
        ...
        //q4a1
        sentences[7] = "Incorrect: The table of results shows that on average British children consumed 18.83 Mediterranean foods per week. 2.781 is the standard deviation.";
        //question 5
        //q5a1
        ...
        //q5a2
        sentences[9] = "Incorrect: The table of results shows that on average Spanish children consumed 20.20 Mediterranean foods per week.";
        //question 6
        //q6a1
        ...
        //q6a2
        sentences[11] = "Incorrect: The table of results shows that Spanish children consumed more Mediterranean foods per week (20.20) than British children (18.83).";
        //question 7
        //q7a1
        ...
        //q7a2
        sentences[13] = "Incorrect: The p-value of .005 shows that there was a statistically significant difference in consumption of Mediterranean foods by British children and Spanish children.";
        //question 8
        //q8a2
        ...
        //q8a1
        sentences[15] = "Incorrect: Overall, the table of results shows that we can conclude that Spanish children did consume significantly more Mediterranean foods per week than British children.";
        //question 9
        //q9a1
        ...
        //q9a2
        sentences[17] = "Incorrect: The p-value (.005) shows that we should reject the null hypothesis since there was a significant difference in consumption of Mediterranean foods by British and Spanish children.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot suggests that the mean number of Mediterranean foods consumed by Spanish children is higher than the mean number consumed by British children.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The box plot suggests that the median number of Mediterranean foods consumed by Spanish children is slightly higher than the median number consumed by British children.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The box plot shows that there is more variability in number of Mediterranean foods consumed by Spanish children than by British children.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value shows that we should reject the null hypothesis.";
            question.SetActive(true);
