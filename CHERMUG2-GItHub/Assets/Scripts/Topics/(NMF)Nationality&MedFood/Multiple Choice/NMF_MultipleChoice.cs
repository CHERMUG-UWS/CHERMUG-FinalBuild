...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NMF_MultipleChoice scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NMF_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "     Spanish Children";
        a2.text = "     Nationality";
        a3.text = "     British Children";
        a4.text = "     Northern Europeans";
        a5.text = "     Consumption of Mediterranean Foods";
        a6.text = "     Obesity";
        a7.text = "     The Checklist";
    }
    ...
    {
        sentences[0] = "Correct: \"Nationality\" and \"Consumption of Mediterranean foods\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Nationality\" is the independent variable (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("NMF_QuestionsHM");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[1].isOn == true && toggles[4].isOn == true && toggles[0].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false)
            {
                //positive
        ...
        if (name == "NextButton2")
        {
            if (toggles[1].isOn == true && toggles[0].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false)
            {
                character.gameObject.GetComponent<CharacterAnims>().states = 2;//Thumbs up anim
                nextButton2.SetActive(false);
                index = 2;
