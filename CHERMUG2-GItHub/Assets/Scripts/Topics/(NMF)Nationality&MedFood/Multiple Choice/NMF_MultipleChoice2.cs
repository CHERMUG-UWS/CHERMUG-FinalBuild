...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NMF_MultipleChoice2 scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NMF_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"consumption of Mediterranean foods\" and participants can score from 0 to 30.";
    ...
    public void ReadyToPlay()
    {
        ...
        a5.text = "     Consumption of Mediterranean Foods";//correct answer
        a6.text = "     Obesity";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("NMF_Hangman");
            }
        }
        //-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        {
            {
                if (toggles[4].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false)
                {
