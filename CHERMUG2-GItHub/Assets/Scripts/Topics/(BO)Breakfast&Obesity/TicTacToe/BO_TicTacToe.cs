...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the BO_TicTacToe scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class BO_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The box plot suggests that the median BMI was higher in the ‘no’ group.";
        //q1a1
        sentences[1] = "Incorrect: The box plot suggests that the median BMI was higher in the ‘no’ group.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The histogram suggests that the ‘yes’ breakfast group data is very skewed.";
        //q2a2
        sentences[3] = "Incorrect: The histogram suggests that the ‘yes’ breakfast group data is very skewed.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The box plot and the histogram both show the same data.";
        //q3a1
        sentences[5] = "Incorrect: The box plot and the histogram both show the same data.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The box plot shows that there are outliers in the ‘yes breakfast’ group.";
        //q4a1
        sentences[7] = "Incorrect: The box plot shows that there are outliers in the ‘yes breakfast’ group.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The table of results shows that the mean BMI for the ‘yes breakfast’ group is 24.6.";
        //q5a2
        sentences[9] = "Incorrect: The table of results shows that the mean BMI for the ‘yes breakfast’ group is 24.6.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The table of results shows a Mann Whitney U statistic of 1025.";
        //q6a2
        sentences[11] = "Incorrect: The table of results shows a Mann Whitney U statistic of 1025.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The histogram suggests that the highest BMI values for the sample are in the ‘yes breakfast’ group.";
        //q7a2
        sentences[13] = "Incorrect: The histogram suggests that the highest BMI values for the sample are in the ‘yes breakfast’ group.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The p-value for the Mann Whitney U test is not statistically significant.";
        //q8a1
        sentences[15] = "Incorrect: The p-value for the Mann Whitney U test is not statistically significant.";
        //question 9
        //q9a1
        sentences[16] = "Correct: Overall, the results show that we can fail to reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: Overall, the results show that we can fail to reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("BO_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddBOTicTacToeScore();
            AchievementManager.instance.Unlock("BO_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot suggests that the median BMI was higher in the ‘no’ group.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The histogram suggests that the ‘yes’ breakfast group data is very skewed.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The box plot and the histogram do not show the same data.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The box plot shows that there are outliers in the ‘no breakfast’ group.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The table of results shows that the mean BMI for the ‘yes breakfast’ group is 1.42.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The table of results shows a Mann Whitney U statistic of 0.197.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The histogram suggests that the highest BMI values for the sample are in the ‘yes breakfast’ group.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The p-value for the Mann Whitney U test is not statistically significant.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "Overall the results show that we can fail to reject the null hypothesis.";
            question.SetActive(true);
