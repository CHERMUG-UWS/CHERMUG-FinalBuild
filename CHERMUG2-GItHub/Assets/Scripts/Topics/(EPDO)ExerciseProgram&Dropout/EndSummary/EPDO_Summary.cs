...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the EPDO_EndSummary scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EPDO_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSc4otKd1vCYiBzqSWlZl3zpDniCnzKEgzGesBDvJObnsD3Tiw/formResponse";
    ...
    void Start()
    {
        ...
        screenCapName = "CertificateEPDO_";
        screenCaps = 1;
        ...
        time = PlayerPrefs.GetString("epdo_timer");
        score = PlayerPrefs.GetString("epdo_scoreString"); 
        ...
        topicText.text = "Exercise Program and Dropout";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateEPDO_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("epdo_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.1662591188", nameAnswer);
        form.AddField("entry.1470373716", scoreAnswer);
        form.AddField("entry.702510700", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("epdo_scoreString");
        timeAnswer = PlayerPrefs.GetString("epdo_timer");
