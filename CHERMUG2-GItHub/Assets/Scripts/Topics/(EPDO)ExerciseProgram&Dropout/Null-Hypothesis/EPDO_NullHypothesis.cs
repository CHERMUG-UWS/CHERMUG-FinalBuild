...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EPDO_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EPDO_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("EPDO_QuestionsData");
    }
    ...
    {   
        ...
        {
           AchievementManager.instance.Unlock("EPDO_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
