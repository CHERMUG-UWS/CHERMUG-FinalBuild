...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the EPDO_QuestionsData scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EPDO_DataQuestions : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: This dataset shows which kind of program each participant took part in (body pump, yoga or circuit training) and whether they stayed on or dropped out of the program.";
        sentences[1] = "Incorrect: The data here suggests that participants took part in two different types of exercise.";
