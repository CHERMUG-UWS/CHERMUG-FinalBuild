...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the EPDO_TicTacToe scene.                       ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EPDO_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: There were 145 participants altogether in this study.";
        //q1a1
        sentences[1] = "Incorrect: There were 145 participants altogether in this study.";
        //question 2
        //q2a1
        sentences[2] = "Correct: Each sports program had a different number of participants.";
        //q2a2
        sentences[3] = "Incorrect: Each sports program had a different number of participants.";
        //question 3
        //q3a2
        sentences[4] = "Correct: Altogether there were more participants in the sample who stayed on their program than who dropped out.";
        //q3a1
        sentences[5] = "Incorrect: Altogether there were more participants in the sample who stayed on their program than who dropped out.";
        //question 4
        //q4a2
        sentences[6] = "Correct: Body pump had the least number of drop outs.";
        //q4a1
        sentences[7] = "Incorrect: Body pump had the least number of drop outs.";
        //question 5
        //q5a1
        sentences[8] = "Correct: Both circuit training and yoga had equal numbers of drop outs.";
        //q5a2
        sentences[9] = "Incorrect: Both circuit training and yoga had equal numbers of drop outs.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The most popular training program was circuit training.";
        //q6a2
        sentences[11] = "Incorrect: The most popular training program was circuit training.";
        //question 7
        //q7a1
        sentences[12] = "Correct: A t-test requires an interval or ratio dependent variable.";
        //q7a2
        sentences[13] = "Incorrect: A t-test requires an interval or ratio dependent variable.";
        //question 8
        //q8a2
        sentences[14] = "Correct: On yoga, more people dropped out than stayed.";
        //q8a1
        sentences[15] = "Incorrect: On yoga, more people dropped out than stayed.";
        //question 9
        //q9a1
        sentences[16] = "Correct: It would be useful to look at the Chi-squared value to see if this result is statistically significant.";
        //q9a2
        sentences[17] = "Incorrect: It would be useful to look at the Chi-squared value to see if this result is statistically significant.";
    ...
    {
        SceneManager.LoadScene("EPDO_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddEPDOTicTacToeScore();
            AchievementManager.instance.Unlock("EPDO_achievement_03");
            StartCoroutine(Type());
        }
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "There were 145 participants altogether in this study.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "Half the participants did the body pump program and half did circuit training.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "Altogether there were more participants in the sample who stayed on their program than who dropped out.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "More people dropped out of the body pump program than the yoga program.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The largest group was those who dropped out of the circuit training program.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The most popular training program was circuit training.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "It would be useful to look at the t test value to see if this result is statistically significant.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "On all three programs, more participants stayed than dropped out.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "It would be useful to look at the Chi-squared value to see if this result is statistically significant.";
            question.SetActive(true);
