...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the EPDO_Hangman scene.                                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class EPDO_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("EPDO_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct; for this study, participants are assigned to a type of exercise program category.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("EPDO_achievement_01");
                    StartCoroutine(Type());
