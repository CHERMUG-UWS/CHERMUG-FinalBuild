...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the NBI_EndSummary scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NBI_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSf6XNuWWjP2HEv4Qjf8FgZB4SP1n7LKJgcfJZ6H0Mah715jtg/formResponse";
    ...
    void Start()
    {
        ...
        time = PlayerPrefs.GetString("nbi_timer");
        score = PlayerPrefs.GetString("nbi_scoreString"); 
        ...
        topicText.text = "Nationality and Body Image";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateNBI_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("nbi_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.1457937951", nameAnswer);
        form.AddField("entry.1243309657", scoreAnswer);
        form.AddField("entry.1391314094", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("nbi_scoreString");
        timeAnswer = PlayerPrefs.GetString("nbi_timer");
