...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the NBI_Hangman scene.                                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NBI_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("NBI_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct; for this study, participants are assigned to a type of nationality.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("NBI_achievement_01");
                    StartCoroutine(Type());
