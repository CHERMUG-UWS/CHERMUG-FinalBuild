...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NBI_MultipleChoice scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NBI_MultipleChoice : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: \"Nationality\" and \"Body image\" are the correct variables.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            SceneManager.LoadScene("NBI_Hangman");
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetNBIScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[2].isOn == true && toggles[5].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false)
            {
                //positive
