...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NBI_NullHypothesis2 scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NBI_NullHypothesis2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        questions.Add(new Answer(0,0, ButtonsHolders));//first section, first button answer
        questions.Add(new Answer(1,0, ButtonsHolders));//second section, first button answer
        questions.Add(new Answer(2,2, ButtonsHolders));//third section, third button answer 
    ...
    {
        sentences[0] = "Please select an answer for all three parts of the alternative hypothesis.";
    }

    public void LoadNextScene()
    {        
        SceneManager.LoadScene("NBI_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("NBI_achievement_03");
        }
    }
    //Called from the OnClick function in the Inspector
