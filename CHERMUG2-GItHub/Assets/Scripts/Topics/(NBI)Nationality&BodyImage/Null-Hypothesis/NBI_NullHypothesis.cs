...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the NBI_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class NBI_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("NBI_NullHypothesis2");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("NBI_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
