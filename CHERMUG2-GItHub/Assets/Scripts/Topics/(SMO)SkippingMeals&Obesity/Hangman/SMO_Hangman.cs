...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the SMO_Hangman scene.                                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMO_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("SMO_QuestionsHM2");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct; for this study, participants are assigned to a weight category.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("SMO_achievement_01");
                    StartCoroutine(Type());
