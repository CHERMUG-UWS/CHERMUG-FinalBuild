...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMO_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMO_NullHypothesis : MonoBehaviour
{
    ...
    private Button q1Button3;//Wrong button
    //Part 2 buttons
    ...
    private Text q1Answer3;//Wrong answer
    //Part 2 answers
    ...
    void Start()
    {
        ...
        questions.Add(new Answer(2,1, ButtonsHolders));//third section, second button answer 
        ...
        q1Button3 = GameObject.Find("Q1_Button3").GetComponent<Button>();
        ...
        q1Answer2 = GameObject.Find("Answer1_Wrong1").GetComponent<Text>();
        q1Answer3 = GameObject.Find("Answer1_Wrong2").GetComponent<Text>();
        ...
        q1Answer3.gameObject.SetActive(false);
    ...
    {        
        SceneManager.LoadScene("SMO_QuestionsData");
    }
    ...
    {   
        ...
        {
           AchievementManager.instance.Unlock("SMO_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
    public void ButtonPress()
    {
        ...
        if (name == "Q1_Button3")
        {
            q1Answer1.gameObject.SetActive(false);
            q1Answer2.gameObject.SetActive(false);
            q1Answer3.gameObject.SetActive(true);

            q1Button1.interactable = true;
            q1Button2.interactable = true;
            q1Button3.interactable = false;
        }
