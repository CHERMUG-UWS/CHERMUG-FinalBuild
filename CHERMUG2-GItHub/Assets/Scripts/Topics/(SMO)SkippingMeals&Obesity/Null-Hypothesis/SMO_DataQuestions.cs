...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMO_QuestionsData scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMO_DataQuestions : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: This dataset shows you whether an individual skips meals (yes, no or sometimes) and whether they are overweight or healthy weight.";
        sentences[1] = "Incorrect: This dataset shows you two different outcomes for each participant - both overweight and healthy weight, where it should only show one outcome, overweight or healthy weight.";
        sentences[2] = "Correct: Good this would be a useful representation for this frequency data. A frequency distribution bar graph could also show the data visually.";
        sentences[3] = "Correct: Good this would be a useful representation for this frequency data. A contingency table would also be useful.";
        sentences[4] = "Incorrect: A box plot is a convenient way of graphically depicting groups of numerical data through their five-number summaries.";
    }
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            ...
            {
                feedback.SetActive(true);
                SceneManager.LoadScene("SMO_AorB");
            }
        }
    }
