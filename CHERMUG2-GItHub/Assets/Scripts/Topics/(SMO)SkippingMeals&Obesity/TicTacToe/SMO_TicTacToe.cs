...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the SMO_TicTacToe scene.                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMO_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: There were equal numbers of girls categorised as a healthy weight or as overweight.";
        //q1a1
        sentences[1] = "Incorrect: There were equal numbers of girls categorised as a healthy weight or as overweight.";
        //question 2
        //q2a1
        sentences[2] = "Correct: Overall there were more girls who skip meals than who do not skip meals.";
        //q2a2
        sentences[3] = "Incorrect: Overall there were more girls who skip meals than who do not skip meals.";
        //question 3
        //q3a2
        sentences[4] = "Correct: Overall the most common response given by the girls was that they sometimes skipped meals.";
        //q3a1
        sentences[5] = "Incorrect: Overall the most common response given by the girls was that they sometimes skipped meals.";
        //question 4
        //q4a2
        sentences[6] = "Correct: There were more overweight girls who skipped meals compared to healthy weight girls.";
        //q4a1
        sentences[7] = "Incorrect: There were more overweight girls who skipped meals compared to healthy weight girls.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The least common response for healthy weight girls was ‘yes’ to skipping meals.";
        //q5a2
        sentences[9] = "Incorrect: The least common response for healthy weight girls was ‘yes’ to skipping meals.";
        //question 6
        //q6a1
        sentences[10] = "Correct: There were more healthy weight girls than overweight girls who do not skip meals.";
        //q6a2
        sentences[11] = "Incorrect: There were more healthy weight girls than overweight girls who do not skip meals.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The most common response for overweight girls was ‘yes’ to skipping meals.";
        //q7a2
        sentences[13] = "Incorrect: The most common response for overweight girls was ‘yes’ to skipping meals.";
        //question 8
        //q8a2
        sentences[14] = "Correct: There were three times as many healthy weight girls who never skipped meals than there were overweight girls.";
        //q8a1
        sentences[15] = "Incorrect: There were three times as many healthy weight girls who never skipped meals than there were overweight girls.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The least common response for healthy weight girls was that they skip meals.";
        //q9a2
        sentences[17] = "Incorrect: The least common response for healthy weight girls was that they skip meals.";
    ...
    {
        SceneManager.LoadScene("SMO_AorB2");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSMOTicTacToeScore();
            AchievementManager.instance.Unlock("SMO_achievement_03");
            StartCoroutine(Type());
        }
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "Overall there were more overweight girls than girls categorised as a healthy weight.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "Overall there were more girls who skip meals than who do not skip meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "Overall the most common response given by the girls was that they sometimes skipped meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "There were more girls of a healthy weight who skipped meals than there were overweight girls who skipped meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The least common response for healthy weight girls was that they do not skip meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "There were more healthy weight girls than overweight girls who do not skip meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The most common response for overweight girls was that they sometimes skip meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "There were more overweight girls who never skipped meals than there were girls of a healthy weight who never skip meals.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The least common response for healthy weight girls was that they skip meals.";
            question.SetActive(true);
