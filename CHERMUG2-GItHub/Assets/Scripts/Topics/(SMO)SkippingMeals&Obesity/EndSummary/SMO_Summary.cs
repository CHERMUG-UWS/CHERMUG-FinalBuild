...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the SMO_EndSummary scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMO_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSehJwALPeo2K21ooCxg0Vb-dDuDztpBP8cHsMYo0a_4eZhVYQ/formResponse";
    ...
    void Start()
    {
        ...
        time = PlayerPrefs.GetString("smo_timer");
        score = PlayerPrefs.GetString("smo_scoreString"); 
        ...
        topicText.text = "Skipping Meals and Obesity";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateSMO_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("smo_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.393450235", nameAnswer);
        form.AddField("entry.1653861289", scoreAnswer);
        form.AddField("entry.231130640", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("smo_scoreString");
        timeAnswer = PlayerPrefs.GetString("smo_timer");
