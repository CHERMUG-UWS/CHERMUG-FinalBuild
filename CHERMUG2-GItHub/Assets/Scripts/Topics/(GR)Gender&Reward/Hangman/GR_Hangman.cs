...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the GR_Hangman scene.                                          ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class GR_Hangman : MonoBehaviour
{
    ...
    {  
        SceneManager.LoadScene("GR_QuestionsHM2");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Nominal: Correct, because there are different categories of reward.";
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                if (AnswersRight == correctLetter.Count)
                {
                    ...
                    AchievementManager.instance.Unlock("SR_achievement_01");
                    StartCoroutine(Type());
