...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the GR_NullHypothesis scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class GR_NullHypothesis : MonoBehaviour
{
    ...
    //Part 1 answers
    [SerializeField] private Text q1Answer1;//Correct answer
    [SerializeField] private Text q1Answer2;//Wrong answer
    //Part 2 answers
    [SerializeField] private Text q2Answer1;//Correct answer
    [SerializeField] private Text q2Answer2;//Wrong answer
    [SerializeField] private Text q2Answer3;//Wrong answer
    //Part 3 answers
    [SerializeField] private Text q3Answer1;//Correct answer
    [SerializeField] private Text q3Answer2;//Wrong answer
    [SerializeField] private Text q3Answer3;//Wrong answer

    //Feedback images (red/green background images)
    [SerializeField] private GameObject part1_Feedback_BG_Wrong;
    [SerializeField] private GameObject part1_Feedback_BG_Correct;
    [SerializeField] private GameObject part2_Feedback_BG_Wrong;
    [SerializeField] private GameObject part2_Feedback_BG_Correct;
    [SerializeField] private GameObject part3_Feedback_BG_Wrong;
    [SerializeField] private GameObject part3_Feedback_BG_Correct;

    //Text that displays when answers are correct/incorrect
    [SerializeField] private Text part1_Incorrect;
    [SerializeField] private Text part1_Correct;
    [SerializeField] private Text part2_Incorrect;
    [SerializeField] private Text part2_Correct;
    [SerializeField] private Text part3_Incorrect;
    [SerializeField] private Text part3_Correct;
    ...
    public string[] sentences; //only one sentence
    private int index;
    ...
    void Start()
    {
        ...
        questions.Add(new Answer(1,2, ButtonsHolders));//second section, third button answer 
    ...
    {        
        SceneManager.LoadScene("GR_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SR_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
