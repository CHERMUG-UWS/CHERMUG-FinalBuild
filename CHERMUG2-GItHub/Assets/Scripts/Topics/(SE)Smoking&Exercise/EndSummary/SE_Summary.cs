...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the SE_EndSummary scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SE_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSehQGp0rIEislZJpwVgWfxCChnFKtD30TrBFkh3H8I7O8HJnw/formResponse";
    ...
    void Start()
    {
        ...
        time = PlayerPrefs.GetString("se_timer");
        score = PlayerPrefs.GetString("se_scoreString"); 
        ...
        topicText.text = "Smoking and Exercise";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateSE_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("se_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.965244918", nameAnswer);
        form.AddField("entry.456540203", scoreAnswer);
        form.AddField("entry.1420961179", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("se_scoreString");
        timeAnswer = PlayerPrefs.GetString("se_timer");
