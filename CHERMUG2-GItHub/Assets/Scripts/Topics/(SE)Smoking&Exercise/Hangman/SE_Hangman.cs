...
public class SE_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("SE_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Ratio: Correct! This is the appropriate level of measurement for Minutes of Exercise.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("SE_achievement_01");
