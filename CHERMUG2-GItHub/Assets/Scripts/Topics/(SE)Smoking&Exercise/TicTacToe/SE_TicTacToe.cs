...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the SE_TicTacToe scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SE_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The scatter plot suggests that there is not really a relationship between the two variables.";
        //q1a1
        sentences[1] = "Incorrect: The scatter plot suggests that there is not really a relationship between the two variables.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The SPSS output shows a negative correlation of -0.14.";
        //q2a2
        sentences[3] = "Incorrect: The SPSS output shows a negative correlation of -0.14.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The scatter plot shows a very small negative correlation.";
        //q3a1
        sentences[5] = "Incorrect: The scatter plot shows a very small negative correlation.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The scatter plot shows that nobody did more than 150 minutes of exercise per week.";
        //q4a1
        sentences[7] = "Incorrect: The scatter plot shows that nobody did more than 150 minutes of exercise per week.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The SPSS output shows that there is a negative relationship between number of cigarettes and minutes of exercise.";
        //q5a2
        sentences[9] = "Incorrect: The SPSS output shows that there is a negative relationship between number of cigarettes and minutes of exercise.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The SPSS output shows that the mean number of daily cigarettes smoked in the sample was 28.88.";
        //q6a2
        sentences[11] = "Incorrect: The SPSS output shows that the mean number of daily cigarettes smoked in the sample was 28.88.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The SPSS output shows that mean minutes of weekly exercise was 89.65.";
        //q7a2
        sentences[13] = "Incorrect: The SPSS output shows that mean minutes of weekly exercise was 89.65.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The SPSS output shows that a correlation has found a p-value of 0.134, which is not significant.";
        //q8a1
        sentences[15] = "Incorrect: The SPSS output shows that a correlation has found a p-value of 0.134, which is not significant.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value for the correlation shows that we cannot reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value for the correlation shows that we cannot reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("SE_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSETicTacToeScore();
            AchievementManager.instance.Unlock("SE_achievement_04");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The scatter plot suggests that there is not really a relationship between the two variables.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The SPSS output shows a negative correlation of -0.14.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The scatter plot shows that nobody did more than 150 minutes of exercise per week.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The SPSS output shows that there is a positive relationship between number of cigarettes and minutes of exercise.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The SPSS output shows that the mean number of daily cigarettes smoked in the sample was 7.434.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The SPSS output shows that mean minutes of weekly exercise was 89.65.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The SPSS output shows that a correlation has found a statistically significant p-value of 0.134.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value for the correlation shows that we cannot reject the null hypothesis.";
            question.SetActive(true);
