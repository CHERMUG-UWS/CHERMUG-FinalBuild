...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SE_MultipleChoice scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SE_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "Doing exercise";
        a2.text = "Minutes of exercise";
        a3.text = "Number of cigarettes";
        a4.text = "Alcohol consumption";
        a5.text = "Sports preference";
        a6.text = "Smoker or not";
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Correct: \"Minutes of exercise\" and \"Number of cigarettes\" are the correct variables.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("SE_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetSEScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[1].isOn == true && toggles[2].isOn == true && toggles[0].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false)
            {
                //positive
