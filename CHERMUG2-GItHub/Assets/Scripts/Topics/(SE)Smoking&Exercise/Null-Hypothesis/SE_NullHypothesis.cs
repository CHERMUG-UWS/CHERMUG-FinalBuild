...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SE_NullHypothesis scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SE_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("SE_NullHypothesis2");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SE_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
