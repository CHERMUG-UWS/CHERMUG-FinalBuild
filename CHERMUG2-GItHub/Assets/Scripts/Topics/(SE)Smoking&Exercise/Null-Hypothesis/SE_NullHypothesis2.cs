...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SE_NullHypothesis2 scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SE_NullHypothesis2 : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("SE_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SE_achievement_03");
        }
    }
    //Called from the OnClick function in the Inspector
