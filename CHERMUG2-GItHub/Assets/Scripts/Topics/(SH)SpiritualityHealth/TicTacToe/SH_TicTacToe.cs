...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the  SH_TicTacToe scene.                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SH_TicTacToe : MonoBehaviour
{
    ...
    [SerializeField] private GameObject scatterPlot;
    ...
    void Awake()
    {
        ...
        scatterPlot = GameObject.Find("ScatterPlotGraph");
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The scatter plot suggests there is a positive relationship between the two variables.";
        //q1a1
        sentences[1] = "Incorrect: The scatter plot suggests there is a positive relationship between the two variables.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The SPSS output shows a positive correlation of 0.227.";
        //q2a2
        sentences[3] = "Incorrect: The SPSS output shows a positive correlation of 0.227.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The scatter plot shows a positive correlation.";
        //q3a1
        sentences[5] = "Incorrect: The scatter plot shows a positive correlation.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The scatter plot shows that nobody scored above 17.5 for Spirituality.";
        //q4a1
        sentences[7] = "Incorrect: The scatter plot shows that nobody scored above 17.5 for Spirituality.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The SPSS output shows that the relationship between Spirituality and Health Behaviour is statistically significant.";
        //q5a2
        sentences[9] = "Incorrect: The SPSS output shows that the relationship between Spirituality and Health Behaviour is statistically significant.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The scatter plot shows that every participant scored above 4 for Health Behaviour.";
        //q6a2
        sentences[11] = "Incorrect: The scatter plot shows that every participant scored above 4 for Health Behaviour.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The SPSS output shows that Spirituality has a larger standard deviation than Health Behaviour.";
        //q7a2
        sentences[13] = "Incorrect: The SPSS output shows that Spirituality has a larger standard deviation than Health Behaviour.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The SPSS output shows that a correlation test has found a statistically significant relationship between the variables.";
        //q8a1
        sentences[15] = "Incorrect: The SPSS output shows that a correlation test has found a statistically significant relationship between the variables.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value for the correlation shows that we should reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: the p-value for the correlation shows that we should reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("SH_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSHTicTacToeScore();
            AchievementManager.instance.Unlock("SH_achievement_04");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The scatter plot suggests there is a positive relationship between the two variables.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The SPSS output shows a positive correlation of 0.227.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The scatter plot shows a strong negative correlation.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The scatter plot shows that nobody scored above 17.5 for Spirituality.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The SPSS output shows that the relationship between Spirituality and Health Behaviour is not statistically significant.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The scatter plot shows that every participant scored above 5 for Health Behaviour.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The SPSS output shows that Spirituality has a larger standard deviation than Health Behaviour.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The SPSS output shows that a t-test has found a statistically significant relationship between the variables.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value for the correlation shows that we should reject the null hypothesis.";
            question.SetActive(true);
