...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SH_NullHypothesis scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SH_NullHypothesis2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        questions.Add(new Answer(0,0, ButtonsHolders));//first section, first button 
    ...
    {        
        SceneManager.LoadScene("SH_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SH_achievement_03");
        }
    }
    //Called from the OnClick function in the Inspector
