...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SH_QuestionsData scene.                             ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SH_DataQuestions : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: This dataset shows numeric values for both variables for each participant.";
        sentences[1] = "Incorrect: Health behaviour should not be a nominal variable.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            ...
            {
                feedback.SetActive(true);
                SceneManager.LoadScene("SH_QuestionsData2");
            }
        }
