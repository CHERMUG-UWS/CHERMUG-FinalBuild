...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the SH_Hangman scene.                                          ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SH_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("SH_QuestionsHM2");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Ratio: Correct! In this study, ratio is the appropriate level of measurement.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("SH_achievement_01");
