...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMBI_QuestionsHM2 scene.                            ///
///                                                                                                         ///                    
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_HangmanQuestions2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: As the variable is measured using numbers.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: This study is looking at the difference in body dissatisfaction across different social media preferences.";
        sentences[3] = "Incorrect: This study is comparing three groups.";
    }
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b> what is the level of measurement of the dependent variable, body dissatisfaction?";
        subq.text = "";
        a1.text = "Interval";
        a2.text = "Ratio";
        a3.text = "Ordinal";
