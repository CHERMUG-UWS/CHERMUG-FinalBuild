...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMBI_QuestionsHM scene.                             ///
///                                                                                                         ///                    
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_HangmanQuestions : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: Instagram, Facebook or no popular social media are the levels of the variable social media group.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: Social media group is a between participants variable.";
        sentences[3] = "Incorrect: Participants only belong to one category of social media use.";
    }
    ...
    {
        SceneManager.LoadScene("SMBI_MultipleChoice2");
    }
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "What are the levels of the variable social media group?";
        subq.text = "";
        a1.text = "Facebook, Instagram or Twitter";
        a2.text = "Group A, Group B and Group C";
        a3.text = "Instagram, Facebook or no popular social media";
        a4.text = "Time on Instagram";
    ...
    public void Q2()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b>, is social media group a between or within participants variable?";
        subq.text = "";
