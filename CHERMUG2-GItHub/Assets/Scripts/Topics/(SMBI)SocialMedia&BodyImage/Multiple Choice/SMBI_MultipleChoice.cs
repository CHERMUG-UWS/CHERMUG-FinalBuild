...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMBI_MultipleChoice scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "Social media group";
        a2.text = "Time spent online";
        a3.text = "Optimism";
        a4.text = "Body satisfaction";
        a5.text = "Facebook";
        a6.text = "Instagram";
    ...
    {
        sentences[0] = "Correct: \"Social media group\" and \"Body dissatisfaction\" are the correct variables.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: \"Social media group\" is the independent variable (IV).";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed && q2Completed)
            {
                ...
                SceneManager.LoadScene("SMBI_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetSMBIScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[0].isOn == true && toggles[6].isOn == true && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false && toggles[7].isOn == false)
            {
                //positive
        ...
        if (name == "NextButton2")
        {
            if (toggles[0].isOn == true && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false && toggles[6].isOn == false && toggles[7].isOn == false)
            {
                character.gameObject.GetComponent<CharacterAnims>().states = 2;//Thumbs up anim
                nextButton2.SetActive(false);
                index = 2;
