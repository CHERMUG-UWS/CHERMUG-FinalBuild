...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMBI_MultipleChoice2 scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_MultipleChoice2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: The dependent variable (DV) is \"Body dissatisfaction\".";
    ...
    public void ReadyToPlay()
    {
        ...
        a5.text = "Facebook";
        a6.text = "Instagram";
        a7.text = "Body dissatisfaction"; //correct answer
        a8.text = "Weight";
    }
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Continue_Button")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("SMBI_QuestionsHM2");
            }
        }
        //----------------------------------------------------------------------------------
        ...
        {
            {
                if (toggles[6].isOn == true && toggles[0].isOn == false && toggles[1].isOn == false && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false && toggles[7].isOn == false)
                {
