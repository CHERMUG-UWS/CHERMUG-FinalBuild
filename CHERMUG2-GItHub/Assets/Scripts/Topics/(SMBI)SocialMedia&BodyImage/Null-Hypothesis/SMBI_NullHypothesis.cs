...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SMBI_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("SMBI_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SMBI_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
