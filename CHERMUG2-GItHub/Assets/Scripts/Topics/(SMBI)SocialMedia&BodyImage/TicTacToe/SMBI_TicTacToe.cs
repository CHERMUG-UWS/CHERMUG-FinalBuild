...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the SMBI_TicTacToe scene.                       ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_TicTacToe : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        spss1 = GameObject.Find("SPSSGraph1");
        spss2 = GameObject.Find("SPSSGraph2");
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The box plot suggests that the Instagram users have the highest body dissatisfaction.";
        //q1a1
        sentences[1] = "Incorrect: The box plot suggests that the Instagram users have the highest body dissatisfaction.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The box plot shows that Instagram users have the highest body dissatisfaction.";
        //q2a2
        sentences[3] = "Incorrect: The box plot shows that Instagram users have the highest body dissatisfaction.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The SPSS 1 results show that the three groups of the independent variable had unequal numbers of participants.";
        //q3a1
        sentences[5] = "Incorrect: The SPSS 1 results show that the three groups of the independent variable had unequal numbers of participants.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The box plot shows that there is an outlier in the Facebook group.";
        //q4a1
        sentences[7] = "Incorrect: The box plot shows that there is an outlier in the Facebook group.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The SPSS 1 results show that the mean body dissatisfaction for Facebook users was 4.87.";
        //q5a2
        sentences[9] = "Incorrect: The SPSS 1 results show that the mean body dissatisfaction for Facebook users was 4.87.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The SPSS 1 results show that the ANOVA test statistic was 7.433.";
        //q6a2
        sentences[11] = "Incorrect: The SPSS 1 results show that the ANOVA test statistic was 7.433.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The SPSS 2 results show that there is not a statistically significant difference between the Facebook and the ‘none’ social media groups, p=0.732.";
        //q7a2
        sentences[13] = "Incorrect: The SPSS 2 results show that there is not a statistically significant difference between the Facebook and the ‘none’ social media groups, p=0.732.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The SPSS 2 results show that the difference between Facebook and Instagram is statistically significant, p=0.008.";
        //q8a1
        sentences[15] = "Incorrect: The SPSS 2 results show that the difference between Facebook and Instagram is statistically significant, p=0.008.";
        //question 9
        //q9a1
        sentences[16] = "Correct: Overall, the results indicate that the null hypothesis can be rejected.";
        //q9a2
        sentences[17] = "Incorrect: Overall, the results indicate that the null hypothesis can be rejected.";
    ...
    {
        SceneManager.LoadScene("SMBI_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSMBITicTacToeScore();
            AchievementManager.instance.Unlock("SMBI_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot suggests that the Instagram users have the highest body dissatisfaction.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The box plot shows that Facebook users have the highest body dissatisfaction.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The SPSS 1 results show that the three groups of the independent variable had exactly the same number of participants.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The box plot shows that there are outliers in the Instagram group.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The SPSS 1 results show that the mean body dissatisfaction for Facebook users was 5.41.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The SPSS 1 results show that the ANOVA test statistic was 8810.186.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The SPSS 2 results for the Tukey post hoc test show that there is not a statistically significant difference between the Facebook and the ‘none’ social media groups.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The SPSS 2 results for the Tukey post hoc test show that the difference between Facebook and Instagram is statistically significant, p=0.008.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "Overall, the results indicate that the null hypothesis can be rejected.";
            question.SetActive(true);
