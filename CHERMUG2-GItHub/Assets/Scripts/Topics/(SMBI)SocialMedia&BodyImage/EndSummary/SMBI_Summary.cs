...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the SMBI_EndSummary scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SMBI_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLScDaqZCwgbDTqDuPRIPbFy6ehJED2HtX5NCckAyvb5CAX4S2A/formResponse";
    ...
    void Start()
    {
        ...
        screenCapName = "CertificateSMBI_";
        screenCaps = 1;
        ...
        time = PlayerPrefs.GetString("smbi_timer");
        score = PlayerPrefs.GetString("smbi_scoreString"); 
        ...
        topicText.text = "Social Media and Body Image";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateSMBI_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    IEnumerator OpenFolder()
    {
        ...
        Send(); //send leaderboard to Google Drive
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("smbi_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.1998395162", nameAnswer);
        form.AddField("entry.326881077", scoreAnswer);
        form.AddField("entry.358138261", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("smbi_scoreString");
        timeAnswer = PlayerPrefs.GetString("smbi_timer");
