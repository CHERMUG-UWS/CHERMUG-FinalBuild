...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SPC_QuestionsHM2 scene.                             ///
///                                                                                                         ///                    
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SPC_HangmanQuestions2 : MonoBehaviour
{
    ...
    {
        sentences[0] = "Correct: In this study the scores for consumption of meat products can range from zero to any larger number.";
        sentences[1] = "Incorrect: Would you like to try again?";
        sentences[2] = "Correct: This study is looking at the difference in meat consumption between two groups.";
    ...
    public void Q1()
    {
        ...
        //Question 1
        q.text = "In this <b>study</b> what level of measurement is appropriate for meat products consumed?";
        subq.text = "";
        a1.text = "Interval";
        a2.text = "Nominal";
        a3.text = "Ratio";
