...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SPC_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SPC_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("SPC_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SPC_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
