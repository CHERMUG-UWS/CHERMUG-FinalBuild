...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SPC_QuestionsData scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SPC_DataQuestions : MonoBehaviour
{
    ...
    {
        //Question 1
        sentences[0] = "Correct: This dataset could be used to test the hypothesis as it shows both males and females and the number of meat products they consumed.";
        sentences[1] = "Incorrect: This dataset only shows males.";
        //Question 2
        sentences[2] = "Correct: Histograms are useful here as they provide visual impressions of the distribution of data. A box plot is also a useful graph.";
        sentences[3] = "Incorrect: Contingency tables display the relationship between two or more categorical variables.";
        sentences[4] = "Correct: Box plots provide five number summaries of the data including the median; they display the spread and skew of the data and identify outliers. Histograms may also be useful.";
        //Question 3
        sentences[5] = "Correct: Well done!";
        sentences[6] = "Incorrect: The male values should not be this low.";
        //Question 4
    ...
    void Update()
    {
        ...
        {
            if (feedbackText.text == sentences[0] || feedbackText.text == sentences[1] || feedbackText.text == sentences[2] || feedbackText.text == sentences[4] || 
                feedbackText.text == sentences[5] || feedbackText.text == sentences[6] || feedbackText.text == sentences[7])
            {
            ...
            if (feedbackText.text == sentences[3] || feedbackText.text == sentences[8])
            {
