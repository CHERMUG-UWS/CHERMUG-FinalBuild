...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the SPC_TicTacToe scene.                        ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SPC_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The box plot suggests that males consumed higher numbers of meat products than females.";
        //q1a1
        sentences[1] = "Incorrect: The box plot suggests that males consumed higher numbers of meat products than females.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The SPSS output shows that there were more males than females in the sample.";
        //q2a2
        sentences[3] = "Incorrect: The SPSS output shows that there were more males than females in the sample.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The box plot shows that the median number of meat products consumed is higher for males than females.";
        //q3a1
        sentences[5] = "Incorrect: The box plot shows that the median number of meat products consumed is higher for males than females.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The box plot shows one outlier for the female group.";
        //q4a1
        sentences[7] = "Incorrect: The box plot shows one outlier for the female group.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The box plot shows more variability in the number of meat products consumed by females compared to males.";
        //q5a2
        sentences[9] = "Incorrect: The box plot shows more variability in the number of meat products consumed by females compared to males.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The table of results shows that on average males consumed 10.52 meat products per week.";
        //q6a2
        sentences[11] = "Incorrect: The table of results shows that on average males consumed 10.52 meat products per week.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The mean values in the table of results show that males consumed more meat products per week than females.";
        //q7a2
        sentences[13] = "Incorrect: The mean values in the table of results show that males consumed more meat products per week than females.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The p-value for the t-test shown in the table of results shows that there is a statistically significant difference between males and females.";
        //q8a1
        sentences[15] = "Incorrect: The p-value for the t-test shown in the table of results shows that there is a statistically significant difference between males and females.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value for the t-test shows that we should reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value for the t-test shows that we should reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("SPC_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSPCTicTacToeScore();
            AchievementManager.instance.Unlock("SPC_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The box plot suggests that males consumed higher numbers of meat products than females.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The SPSS output shows that there were more males than females in the sample.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The box plot shows that the median number of meat products consumed is higher for females than males.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The box plot shows one outlier (a participant outside the typical range of scores) for the female group.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The box plot shows more variability in the number of meat products consumed by males compared to females.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The table of results shows that on average males consumed 9.32 meat products per week.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The mean values in the table of results show that males consumed more meat products per week than females.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The p-value for the t-test shown in the table of results shows that there is not a statistically significant difference between males and females.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value for the t-test shows that we should reject the null hypothesis.";
            question.SetActive(true);
