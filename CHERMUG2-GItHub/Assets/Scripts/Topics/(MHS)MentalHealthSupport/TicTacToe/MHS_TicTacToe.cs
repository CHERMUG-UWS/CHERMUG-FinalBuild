...
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the  MHS_TicTacToe scene.                       ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MHS_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The scatter plot suggests there is a positive relationship between mental health and perceived social support.";
        //q1a1
        sentences[1] = "Incorrect: The scatter plot suggests there is a positive relationship between mental health and perceived social support.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The SPSS output shows the correlation value is 0.352.";
        //q2a2
        sentences[3] = "Incorrect: The SPSS output shows the correlation value is 0.352.";
        //question 3
        //q3a2
        ...
        //question 4
        //q4a2
        sentences[6] = "Correct: The scatter plot suggests that there is a positive relationship between the variables.";
        //q4a1
        sentences[7] = "Incorrect: The scatter plot suggests that there is a positive relationship between the variables.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The SPSS output shows that there is a positive correlation between the variables.";
        //q5a2
        sentences[9] = "Incorrect: The SPSS output shows that there is a positive correlation between the variables.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The SPSS output shows that the standard deviation for mental health scores is 1.5612.";
        //q6a2
        sentences[11] = "Incorrect: The SPSS output shows that the standard deviation for mental health scores is 1.5612.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The SPSS output shows that there were 218 participants in the sample.";
        //q7a2
        sentences[13] = "Incorrect: The SPSS output shows that there were 218 participants in the sample.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The p-value in the table shows that there is a statistically significant relationship between mental health and perceived social support.";
        //q8a1
        sentences[15] = "Incorrect: The p-value in the table shows that there is a statistically significant relationship between mental health and perceived social support.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value of 0.000 shows that we should reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value of 0.000 shows that we should reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("MHS_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddMHSTicTacToeScore();
            AchievementManager.instance.Unlock("MHS_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The scatter plot suggests there is a positive relationship between mental health and perceived social support.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The SPSS output shows the correlation value is 0.352.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The scatter plot suggests that there is no relationship between the variables.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The SPSS output shows that there is a negative correlation between the variables.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The SPSS output shows that the mean mental health score is 1.5612.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The SPSS output shows that there were 218 participants in the sample.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The p-value in the table shows that there is not a statistically significant relationship between mental health and perceived social support.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value of 0.000 shows that we should reject the null hypothesis.";
            question.SetActive(true);
