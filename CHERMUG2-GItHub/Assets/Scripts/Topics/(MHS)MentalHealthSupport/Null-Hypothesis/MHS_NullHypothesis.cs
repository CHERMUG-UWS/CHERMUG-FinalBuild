...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the MHS_NullHypothesis scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MHS_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("MHS_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("MHS_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
