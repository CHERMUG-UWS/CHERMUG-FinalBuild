...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the MHS_Hangman scene.                                         ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MHS_Hangman : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        correctLetter.Add(4);//E
        correctLetter.Add(17);//R
        correctLetter.Add(21);//V
    ...
    {   
        SceneManager.LoadScene("MHS_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Interval: Correct! in this study, Interval is an appropriate level of measurement.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("MHS_achievement_01");
