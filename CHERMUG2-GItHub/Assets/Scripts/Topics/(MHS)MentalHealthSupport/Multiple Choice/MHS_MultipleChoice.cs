...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the MHS_MultipleChoice scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class MHS_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "     Perceived social support";
        a2.text = "     Number of friends";
        a3.text = "     Mental health";
        a4.text = "     Physical health";
        a5.text = "     Anxiety";
        a6.text = "     Happiness";
    }
    ...
    {
        sentences[0] = "Correct: \"Perceived social support\" and \"Mental health\" are the correct variables.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            ...
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("MHS_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetMHSScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[0].isOn == true && toggles[1].isOn == false && toggles[2].isOn == true && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false)
            {
                //positive
