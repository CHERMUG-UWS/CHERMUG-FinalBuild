...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SESM_NullHypothesis scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_NullHypothesis : MonoBehaviour
{
    ...
    {        
        SceneManager.LoadScene("SESM_QuestionsData");
    }
    ...
    {   
        ...
        {
            AchievementManager.instance.Unlock("SESM_achievement_02");
        }
    }
    //Called from the OnClick function in the Inspector
