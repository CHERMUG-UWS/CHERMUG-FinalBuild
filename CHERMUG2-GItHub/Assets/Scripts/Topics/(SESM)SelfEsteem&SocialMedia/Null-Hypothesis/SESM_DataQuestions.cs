...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SESM_QuestionsData scene.                           ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_DataQuestions : MonoBehaviour
{
    ...
    private GameObject graph1Button;
    private GameObject graph2Button;
    ...
    void Start()
    {
        ...
        graph1Button = GameObject.Find("Q3A1");
        graph2Button = GameObject.Find("Q3A2");
    ...
    {
        //Question 1
        sentences[0] = "Correct: This dataset shows suitable data for this study.";
        sentences[1] = "Incorrect: This study shows self esteem as a nominal variable.";
        //Question 2
        ...
        sentences[5] = "Incorrect: This is not their prediction.";
        //Question 4
        sentences[6] = "Correct: You have an ordinal variable.";
    ...
    void Update()
    {
        ...
        for (int i = 0; i < sentences.Length; i++)
        {
            if (feedbackText.text == sentences[0] || feedbackText.text == sentences[1] || feedbackText.text == sentences[2] ||
                feedbackText.text == sentences[4] || feedbackText.text == sentences[5] || feedbackText.text == sentences[6])
            {
            ...
            if (feedbackText.text == sentences[3] || feedbackText.text == sentences[7])
            {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "Q3A1")
        {
            ...
            ActivateFeedback();
            scoreBar.gameObject.GetComponent<ScoreSystem>().RemoveSESMScore();
            graph1Button.SetActive(false);
            graph2Button.SetActive(false);
        }
