...
///                                   SELF ESTEEM AND SOCIAL MEDIA TOPIC                                    ///
///                               -------------------------------------------                               ///  
/// Script is attached to the Game Controller GameObject in the SESM_TicTacToe scene.                       ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_TicTacToe : MonoBehaviour
{
    ...
    public void SpeechBubbleText()
    {
        //question 1
        //q1a2
        sentences[0] = "Correct: The scatter plot suggests there is a negative correlation between the variables.";
        //q1a1
        sentences[1] = "Incorrect: The scatter plot suggests there is a negative correlation between the variables.";
        //question 2
        //q2a1
        sentences[2] = "Correct: The SPSS output shows a negative correlation of -0.356.";
        //q2a2
        sentences[3] = "Incorrect: The SPSS output shows a negative correlation of -0.356.";
        //question 3
        //q3a2
        sentences[4] = "Correct: The scatter plot shows that there is possibly a relationship between the variables.";
        //q3a1
        sentences[5] = "Incorrect: The scatter plot shows that there is possibly a relationship between the variables.";
        //question 4
        //q4a2
        sentences[6] = "Correct: The scatter plot shows that all participants reported using social media for less than 75 minutes per day.";
        //q4a1
        sentences[7] = "Incorrect: The scatter plot shows that all participants reported using social media for less than 75 minutes per day.";
        //question 5
        //q5a1
        sentences[8] = "Correct: The SPSS output shows that 90 participants took part in the study.";
        //q5a2
        sentences[9] = "Incorrect: The SPSS output shows that 90 participants took part in the study.";
        //question 6
        //q6a1
        sentences[10] = "Correct: The scatter plot shows that most participants rated their self esteem between 3 and 5.";
        //q6a2
        sentences[11] = "Incorrect: The scatter plot shows that most participants rated their self esteem between 3 and 5.";
        //question 7
        //q7a1
        sentences[12] = "Correct: The SPSS output shows that the median self esteem rating was 4.";
        //q7a2
        sentences[13] = "Incorrect: The SPSS output shows that the median self esteem rating was 4.";
        //question 8
        //q8a2
        sentences[14] = "Correct: The SPSS output shows that a Spearman’s rank correlation has found a p-value of 0.001.";
        //q8a1
        sentences[15] = "Incorrect: The SPSS output shows that a Spearman’s rank correlation has found a p-value of 0.001.";
        //question 9
        //q9a1
        sentences[16] = "Correct: The p-value for the Spearman’s rank correlation shows that we should reject the null hypothesis.";
        //q9a2
        sentences[17] = "Incorrect: The p-value for the Spearman’s rank correlation shows that we should reject the null hypothesis.";
    ...
    {
        SceneManager.LoadScene("SESM_QuestionsTTT");
    }
    ...
    public void EndTurn()
    {
            ...
            buttonList[2].text == "X" && buttonList[4].text == "X" && buttonList[6].text == "X")
        {
            ...
            ttt.SetActive(false);
            finished = true;
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSESMTicTacToeScore();
            AchievementManager.instance.Unlock("SESM_achievement_03");
            StartCoroutine(Type());
        }
        if (moveCount >= 7)
        {
    ...
    public void ButtonPress()
    {
        ...
        if (name == "GridSpace1")
        {
            questionText.text = "The scatter plot suggests there is a strong positive correlation between the variables.";
        ...
        if (name == "GridSpace2")
        {
            questionText.text = "The SPSS output shows a positive correlation of -0.356.";
            question.SetActive(true);
        ...
        if (name == "GridSpace3")
        {
            questionText.text = "The scatter plot shows that there is no relationship between the variables.";
            question.SetActive(true);
        ...
        if (name == "GridSpace4")
        {
            questionText.text = "The scatter plot shows that all participants reported using social media for less than 75 minutes per day.";
            question.SetActive(true);
        ...
        if (name == "GridSpace5")
        {
            questionText.text = "The SPSS output shows that 180 participants took part in the study.";
            question.SetActive(true);
        ...
        if (name == "GridSpace6")
        {
            questionText.text = "The scatter plot shows that most participants rated their self esteem as 1 or 2.";
            question.SetActive(true);
        ...
        if (name == "GridSpace7")
        {
            questionText.text = "The SPSS output shows that the median self esteem rating was 4.";
            question.SetActive(true);
        ...
        if (name == "GridSpace8")
        {
            questionText.text = "The SPSS output shows that a t-test has found a p-value of 0.001.";
            question.SetActive(true);
        ...
        if (name == "GridSpace9")
        {
            questionText.text = "The p-value for the Spearman’s rank correlation shows that we should reject the null hypothesis.";
            question.SetActive(true);
