...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SESM_QuestionsTTT scene.                            ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_TicTacToeQuestions : MonoBehaviour
{
    ...
    {
        //Question 1
        sentences[0] = "Correct: A Spearman’s rank correlation found a statistically significant negative correlation between social media use and self-esteem, r(88)=-0.356, p=0.001.";
        sentences[1] = "Incorrect: Would you like to try again?";
        //Question 2
        sentences[2] = "Correct: Your result is statistically significant.";
        sentences[3] = "Incorrect: Your result is statistically significant.";
        //Question 3
        sentences[4] = "Correct: The negative correlation between the variables suggests that as time spent on social media increases, self-esteem decreases. Social media could have a negative influence on self esteem.";
        sentences[5] = "Incorrect: The negative correlation between the variables suggests that as time spent on social media increases, self-esteem decreases. Social media could have a negative influence on self esteem.";
    }
    ...
    {
        SceneManager.LoadScene("SESM_EndSummary");
    }
    ...
    public void Next()
    {
        if(q3Answered)
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().AddSESMScore();
            question1 = true;
            question2 = false;
            question3 = false;
            StartCoroutine(Type());
        ...
        if(q1Answered)
        {
            ...
            ActivateFeedback();
            nextButton.SetActive(false);
            scoreBar.gameObject.GetComponent<ScoreSystem>().RemoveSESMScore();
            question1 = true;
            question2 = false;
            question3 = false;
            StartCoroutine(Type());
    ...
    public void Q1()
    {
        ...
        subq.text = "";
        a1q1.text = "A Pearson’s correlation found a statistically significant negative correlation between social media use and self-esteem, r(88)=-0.356, p=0.001.";
        a2q1.text = "A Spearman’s rank correlation found a statistically significant positive correlation between social media use and self-esteem, r(88)=0.356, p=0.001.";
        a3q1.text = "A Spearman’s rank correlation found a statistically significant negative correlation between social media use and self-esteem, r(88)=-0.356, p=0.001.";
    }
    ...
    {   
        ...
        subq.text = "";
        a1q3.text = "The negative correlation between the variables suggests that as time spent on social media increases, self-esteem decreases. Social media could have a negative influence on self esteem.";
        a2q3.text = "The negative correlation between the variables suggests that both variables decrease together, so less time on social media may result in lower self-esteem.";
    }
    //--------------------------------------------------------------------
