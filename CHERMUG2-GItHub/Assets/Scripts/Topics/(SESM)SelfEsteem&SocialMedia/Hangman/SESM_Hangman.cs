...
///                               -------------------------------------------                               ///  
/// Script is attached to the GameManager in the SESM_Hangman scene.                                        ///
///                                                                                                         ///                         
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_Hangman : MonoBehaviour
{
    ...
    {   
        SceneManager.LoadScene("SESM_QuestionsHM");
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Ratio: Correct! This is the appropriate level of measurement for time on social media.";
    ...
    public void CheckWinOrLose()
    {
        ...
        foreach (int v in correctLetter)
        {
            if (buttons[v].interactable == false)
            {
                ...
                {
                    AchievementManager.instance.Unlock("SESM_achievement_01");
