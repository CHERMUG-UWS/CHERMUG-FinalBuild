...
///                               -------------------------------------------                               ///  
/// Script is attached to the Manager GameObject in the SESM_MultipleChoice scene.                          ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_MultipleChoice : MonoBehaviour
{
    ...
    public void ResetQ1()
    {
        ...
        a1.text = "Time on social media";
        a2.text = "Self esteem";
        a3.text = "Happiness";
        a4.text = "Using Twitter";
        a5.text = "Anxiety";
        a6.text = "Mental health";
    }

    public void SpeechBubbleText()
    {
        sentences[0] = "Correct: \"Time on social media\" and \"Self esteem\" are the correct variables.";
    ...
    public void ButtonPress()
    {
        ...
        if (name == "PassButton")
        {
            if (q1Completed)
            {
                ...
                SceneManager.LoadScene("SESM_Hangman");
            }
        }
        ...
        if (name == "ScenarioButton_Ready")
        {
            ...
            scoreBar.gameObject.GetComponent<ScoreSystem>().SetSESMScore();
        }
        ...
        if (name == "NextButton")
        {
            if (toggles[0].isOn == true && toggles[1].isOn == true && toggles[2].isOn == false && toggles[3].isOn == false && toggles[4].isOn == false && toggles[5].isOn == false)
            {
                //positive
