...
///                               -------------------------------------------                               ///  
/// Script is attached to the SceneManager GameObject in the SESM_EndSummary scene.                         ///
///                                                                                                         ///
//////////////////////////////////////////////////</summary>///////////////////////////////////////////////////

public class SESM_Summary : MonoBehaviour
{
    ...
    [SerializeField] private string BASE_URL = "https://docs.google.com/forms/u/2/d/e/1FAIpQLSd1ibKrmEOQVS2G0wRMiBjc63X4teeAkaIIVb3MDc2gzta0WQ/formResponse";
    ...
    void Start()
    {
        ...
        screenCapName = "CertificateSESM_";
        screenCaps = 1;
        ...
        time = PlayerPrefs.GetString("sesm_timer");
        score = PlayerPrefs.GetString("sesm_scoreString"); 
        ...
        topicText.text = "Self Esteem and Social Media";
    ...
    public void SaveCertificateImage()
    {
        ...
        screenCapName = "CertificateSESM_" + System.DateTime.Now.ToString("dd-MM-yy") + "_" + (screenCaps+1) + ".png";
    ...
    void Update()
    {
        timerText.text = PlayerPrefs.GetString("sesm_timer");
    }
    ...
    IEnumerator PostToGoogle(string nameAnswer, string scoreAnswer, string timeAnswer)
    {
        ...
        form.AddField("entry.788242998", nameAnswer);
        form.AddField("entry.1660428404", scoreAnswer);
        form.AddField("entry.525925175", timeAnswer);
    ...
    public void Send()
    {
        ...
        scoreAnswer = PlayerPrefs.GetString("sesm_scoreString");
        timeAnswer = PlayerPrefs.GetString("sesm_timer");
